...
SECRET_KEY = "django-insecure-fkf-!7ur91(e0j75%w7#rz!$n#4vfnhtir828n_lb!@ik23)*#"
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'courses/templates')],  # Make sure this is set correctly
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'NAME': 'elearning_by_sohit',
        'USER': 'elearning_by_sohit_user',
        'PASSWORD': 'EqGMRUGDYvBBr3dZ9amztJzsfJZAoIj8',  # Replace with your actual password
        'HOST': 'dpg-cs495v5svqrc7387je90-a.oregon-postgres.render.com',
        'PORT': '5432',
    }
}
